...
.badge-CRITICAL { background: rgba(220,38,38,.1);   color: var(--critical); border: 1px solid rgba(220,38,38,.3); }
.badge-HIGH     { background: rgba(234,88,12,.1);   color: var(--high);     border: 1px solid rgba(234,88,12,.3); }
.badge-MODERATE { background: rgba(202,138,4,.1);   color: var(--moderate); border: 1px solid rgba(202,138,4,.3); }
.badge-LOW      { background: rgba(22,163,74,.1);   color: var(--low);      border: 1px solid rgba(22,163,74,.3); }
...
TIER_BG = {
    ...
    "HIGH":     "rgba(234,88,12,.06)",
    "MODERATE": "rgba(202,138,4,.07)",
...
with col_main:
        ...
        try:
            ...
            if all_d:
                ...
                fig = go.Figure(go.Bar(
                    ...
                    textfont      = dict(color="#0d1117", size=14),
                ))
                fig.update_layout(
                    plot_bgcolor  = PB, paper_bgcolor = PB,
                    xaxis         = dict(showgrid=False, color="#6b7280",
                                         tickfont=dict(size=13, color="#0d1117")),
    ...
    cards += f"""
    <div class="metric-card" style="--card-accent:#e63950">
    ...
    with ch1:
        ...
        fig_bar.update_layout(
            ...
            xaxis         = dict(showgrid=False, zeroline=False,
                                  showticklabels=False, color="#6b7280"),
            yaxis         = dict(showgrid=False, color="#0d1117",
    ...
    with ch2:
        ...
        fig_pie.update_layout(
            plot_bgcolor = PB, paper_bgcolor = PB,
            legend       = dict(font=dict(color="#0d1117", size=10), bgcolor=PB),
            ...
            annotations  = [dict(
                ...
                font      = dict(size=15, color="#0d1117"),
            )],
        )
