...
#             self._model, self._df_raw, self._df_norm = get_child_protection_pipeline(self.project_root)
#         return self._model
#
...
#         )
#
#     def child_invoke(self, request: BudgetAllocationRequest, config=None) -> ChildBudgetAllocationResponse:
...
#             avg = self.model.case_df[["District", "Avg_cases"]].drop_duplicates("District")
